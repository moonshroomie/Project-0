...
# I coded all the inputs and if statements, i just had AI add the loops like these ones
...
while not conversation_complete:
    ...
    while not in_conversation: # loop generated by AI
        ...
        if d1 == "e":
            ...
            in_conversation = True  # the conversation starts
        elif d1 == "q":
            ...
            if d2 == "e":
                ...
                while not found_lighters:
                    ...
                    if d2 == "l":
                        ...
                        print()
                        typewriter_effect("You're back in the backroom. Left or Right?", delay=0.04, color=Colors.BRIGHT_MAGENTA)
                    elif d2 == "i":
        ...
        while True:
            ...
            if d3 == "g":
                if lighters in player.inventory:
                    player.inventory.remove(lighters)
...
# Continue with the next part of the script (line 180)
print()
typewriter_effect("A few moments after the man leaves, a woman walks in....", delay=0.04, color=Colors.BRIGHT_MAGENTA)
print()
# generated by AI because I didn't know how to implement the typewriter effect
