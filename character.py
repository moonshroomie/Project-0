...
The `Character` class provides functionality for managing a character's attributes, such as name, health, inventory, and dialogue. It includes methods for displaying the character's inventory, receiving new items, and interacting with the player through a typewriter effect.

The `Colors` class provides a set of ANSI escape codes for coloring the output in the terminal.
"""
import sys
import time
...
class Character:
    ...
    def typewriter_effect(self, text, delay=0.1, color=Colors.RESET): # function generated by AI
    ...
    def talk_to_player(self, message_key): # function generated by AI
    ...
    def show_inventory(self): # function generated by AI
    ...
    def receive_item(self, item): # function generated by AI
